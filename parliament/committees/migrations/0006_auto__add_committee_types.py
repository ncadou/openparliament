...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Committee.parl_id'
        db.add_column('committees_committee', 'parl_id', self.gf('django.db.models.fields.CharField')(default=None, max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'Committee.house'
        db.add_column('committees_committee', 'house', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)

        # Adding field 'Committee.senate'
        db.add_column('committees_committee', 'senate', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'Committee.parl_id'
        db.delete_column('committees_committee', 'parl_id')

        # Deleting field 'Committee.house'
        db.delete_column('committees_committee', 'house')

        # Deleting field 'Committee.senate'
        db.delete_column('committees_committee', 'senate')
    ...
    models = {
        'committees.committee': {
            ...
            'house': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
            ...
            'parl_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '15'}),
