...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Politician.allow_subscriptions'
        db.add_column('core_politician', 'allow_subscriptions',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Politician.allow_subscriptions'
        db.delete_column('core_politician', 'allow_subscriptions')
    ...
    models = {
        ...
        'core.politician': {
            ...
            'allow_subscriptions': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
